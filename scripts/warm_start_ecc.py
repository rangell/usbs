...
class EccClusterer(object):
    ...
    def __init__(self,
        ...
        self.sparse_laplacian = create_sparse_laplacian(edge_weights=edge_weights, eps=0.999)
    ...
    def _call_sdp_solver(self, sdp_state: SDPState, solver_name: str) -> None:
        ...
        if "specbm" in solver_name:
            trace_ub = (self.hparams.trace_factor
                        ...
                        * sdp_state.SCALE_X)
            #_rho = hparams.rho if "cold" in solver_name else 0.005
            _rho = self.hparams.rho
            #_k_curr = self.hparams.k_curr if "cold" in solver_name else 4
